void ingresar() {
  ...
  textAlign(LEFT);
  text("Nombre", width/7, height/2-70); 
  text("Tipo de establecimiento", width/7, height/2+30);
  text("Nombre del representante", width/7, height/2+130); 
  text("Teléfono", width/7, height/2+230); 
  popStyle();
}